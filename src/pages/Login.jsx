...
import { Shield, User, Lock, EyeOff, Eye, Cpu, CheckCircle, Focus, Aperture } from 'lucide-react';
...
const HeroLensLogo = () => (
  <div className="relative flex items-center justify-center w-40 h-40">
    ...
    <div className="absolute z-20 flex items-center justify-center w-12 h-12 bg-slate-950 rounded-full shadow-[inset_0_0_15px_rgba(0,0,0,1)] border border-indigo-500/40 mt-1.5">
...
function Login() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 font-sans text-slate-50 selection:bg-indigo-500/30">
      
      {/* LEFT SIDE - Dark Branding & Glowing Effects */}
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center p-12 relative overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-slate-950 border-r border-slate-800/50">
        ...
        <div className="z-10 bg-slate-900/40 backdrop-blur-2xl p-10 rounded-[3rem] shadow-[0_0_60px_rgba(79,70,229,0.15)] mb-10 border border-slate-700/50 flex items-center justify-center relative">
        ...
        <h1 className="z-10 text-4xl font-extrabold mb-4 text-center tracking-tight text-white">
        ...
        <p className="z-10 text-slate-400 text-center max-w-md mb-12 text-base leading-relaxed">
        ...
        <div className="z-10 flex gap-6 mb-8">
          <div className="bg-slate-900/80 backdrop-blur-sm p-5 rounded-2xl shadow-xl flex flex-col items-center w-36 transition-transform hover:-translate-y-1 border border-slate-800">
            <div className="bg-indigo-500/10 p-3 rounded-xl mb-3 text-indigo-400 border border-indigo-500/20">
              <CheckCircle className="w-6 h-6"/>
            </div>
            <span className="text-sm font-bold text-slate-300">Real-time</span>
          </div>
          <div className="bg-slate-900/80 backdrop-blur-sm p-5 rounded-2xl shadow-xl flex flex-col items-center w-36 transition-transform hover:-translate-y-1 border border-slate-800">
            <div className="bg-violet-500/10 p-3 rounded-xl mb-3 text-violet-400 border border-violet-500/20">
              <Cpu className="w-6 h-6"/>
            </div>
            <span className="text-sm font-bold text-slate-300">Explainable</span>
          </div>
          <div className="bg-slate-900/80 backdrop-blur-sm p-5 rounded-2xl shadow-xl flex flex-col items-center w-36 transition-transform hover:-translate-y-1 border border-slate-800">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-slate-950 relative">
        ...
        <div className="w-full max-w-md bg-slate-900 p-10 rounded-[2rem] shadow-2xl border border-slate-800 relative z-10">
          ...
          <h2 className="text-3xl font-extrabold mb-2 tracking-tight text-white">Welcome Back 👋</h2>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full pl-11 pr-4 py-3.5 border border-slate-700/50 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 bg-slate-950 transition-all font-medium text-white placeholder:text-slate-500 shadow-inner" 
                required 
              />
            </div>
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full pl-11 pr-12 py-3.5 border border-slate-700/50 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 bg-slate-950 transition-all font-medium text-white placeholder:text-slate-500 shadow-inner" 
                required 
              />
              <div 
            ...
            <div className="flex items-center justify-between text-sm mt-6">
              <label className="flex items-center cursor-pointer group">
                <input type="checkbox" className="w-4.5 h-4.5 text-indigo-500 rounded-md border-slate-700 bg-slate-900 focus:ring-indigo-500 focus:ring-offset-slate-900 cursor-pointer" />
                <span className="ml-2.5 text-slate-400 font-semibold group-hover:text-slate-200 transition-colors">Remember me</span>
              </label>
              <a href="#" className="text-indigo-400 font-bold hover:text-indigo-300 hover:underline transition-colors">Forgot Password?</a>
            </div>

            <button type="submit" className="w-full bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-400 hover:to-violet-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_30px_rgba(79,70,229,0.5)] mt-6 active:scale-[0.98]">
              Sign in
            </button>
          </form>
          ...
          <div className="mt-8 relative flex items-center justify-center">
            ...
            <span className="absolute bg-slate-900 px-4 text-sm font-semibold text-slate-500">OR</span>
          </div>

          <div className="mt-8 grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center border border-slate-700/50 bg-slate-950 py-3 rounded-xl hover:bg-slate-800 font-bold text-slate-300 transition-colors shadow-sm">
          ...
          <p className="mt-10 text-center text-sm text-slate-400 font-medium">
            ...
            <a href="#" className="font-extrabold text-indigo-400 hover:text-indigo-300 hover:underline transition-colors">
              Sign up for free
            </a>
          </p>
